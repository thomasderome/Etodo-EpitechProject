      ...
      >
        <DialogPanel>
          <form>
            ...
            <div className="m-2 flex">
              <div className="text-sm p-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    set_setting_data(
                      setting_data ? { ...setting_data, name: e.currentTarget.value } : null
                    )
                  }
                  required
                />
              ...
              <div className="text-sm p-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    set_setting_data(
                      setting_data ? { ...setting_data, firstname: e.currentTarget.value } : null
                    )
                  }
                  required
                ></Input>
            ...
            <div className="m-2 flex">
              <div className="text-sm p-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    set_setting_data(
                      setting_data ? { ...setting_data, email: e.currentTarget.value } : null
                    )
                  }
                  required
                />
              ...
              <div className="text-sm p-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    set_setting_data(
                      setting_data ? { ...setting_data, password: e.currentTarget.value } : null
                    )
                  }
                  required
                />
            ...
            <DialogFooter>
              <Button onClick={() => set_setting_state(false)} type="button" variant="outline">
                Cancel
              </Button>
                ...
                <Tooltip open={add_share_errer}>
                  <TooltipTrigger asChild>
                    <Input
                      type={'email'}
                      name={'email'}
                      onChange={() => (add_share_errer ? null : set_add_share_errer(false))}
                      required
                    />
                  </TooltipTrigger>
                  <TooltipContent
                ...
                <SidebarMenuItem>
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      ...
                      >
                        <User_label
                          name={user_data?.firstname ? user_data.firstname : ''}
                          image={user_data?.avatar ? user_data.avatar : ''}
